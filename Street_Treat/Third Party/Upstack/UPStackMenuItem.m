...
const static UPStackMenuItemLabelPosition_e kStackMenuItemDefaultLabelPosition  = UPStackMenuItemLabelPosition_right;
...
- (id)initWithImage:(UIImage*)image highlightedImage:(UIImage*)highlightedImage title:(NSString*)title font:(UIFont*)font
{
    ...
    if(self) {
       ...
       // _labelContainer.backgroundColor = [UIColor darkGrayColor];
