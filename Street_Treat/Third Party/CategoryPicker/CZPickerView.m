...
- (id)initWithHeaderTitle:(NSString *)headerTitle
    ...
    if(self){
        ...
        self.headerBackgroundColor = [UIColor redColor];
        
        self.cancelButtonNormalColor = [UIColor redColor];
        ...
        self.confirmButtonHighlightedColor = [UIColor redColor];
        self.confirmButtonBackgroundColor = [UIColor redColor];
